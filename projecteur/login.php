<?php
	...
	if( $return == false ) {
		...
		header( 'Location: http://projecteur.alteretgo.my-workflow.fr/' );
	...
	header( 'Location: http://projecteur.alteretgo.my-workflow.fr/session.php?formateur=' . $return[ 'uuid' ] );
	die( 'Allowed connection - 0x00000003' );
?>
