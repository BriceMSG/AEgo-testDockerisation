...
<body>
	...
	<?php
		$_menu_title = "Actions managériales";
		$_extra_button = '';
		...
		<div id="appSelect">
			<div class="vwrap">
				<div class="valign">
					...
					<div class="row">
						<div class="col-4">
							<div class="card hide" id="action1"></div>
						</div>
						<div class="col-4">
							<div class="card hide" id="action2"></div>
						</div>
						<div class="col-4">
							<div class="card hide" id="action3"></div>
						</div>
					</div>
					<div class="row">
						<div class="col-4">
							<div class="card hide" id="action4"></div>
						</div>
						<div class="col-4">
							<div class="card hide" id="action5"></div>
						</div>
						<div class="col-4"></div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		function callbackMsg( _msg ) {
			...
			if ( _msg.msg == 'actions-manageriales-part' ) {
			...
			else if ( _msg.msg == 'actions-manageriales' ) {
		...
		function retriveAnswer( _answers ) {
			...
			$( '#appSelect [id^=action]').addClass( 'hide' ).html( '' );
			for ( var i = 0; i < _nbrAnswer; i++ ) {
				tmp = JSON.parse( _answers.answer[ i ].data );
				cible = $( '#action' + ( i + 1 ) );
				cible.removeClass( 'hide' ).html( tmp.result.response );
			}
