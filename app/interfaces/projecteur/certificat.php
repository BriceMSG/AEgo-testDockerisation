...
<body>
	<div id="header">
		<div class="row">
			...
			<div class="col-2 blw" onclick="window.print();">
	...
	<div id="content" class="">
		<div class="card block center w768">
			<!--<h1 class="txt-center display2 alter-btn-text">Formation au "Change Management"</h1>
			<div class="row"></div>-->
			<div class="row">
				<div class="col-1"></div>
				<div class="col-5">
				...
				<div class="col-1"></div>
				<div id="star" class="col-3 alter-sombre-text" style="font-size: 6rem; line-height: 6rem;">
			...
			<div class="row">
				...
				<div class="col-1"></div>
				<div class="col-3">
					<h3 class="display2 alter-btn-text"><?php echo str_replace( '.', ',', round( ( ( $total[ 'score' ] / $total[ 'nbr' ] ) * 100 ), 2 ) ); ?> %</h3>
				</div>
				<div class="col-1"></div>
			</div>
		</div>
	...
	<script type="text/javascript">
		function checkIo() {
			if ( my_lcs.my_io != null && typeof my_lcs.my_io !== 'undefined' ) {
				clearInterval( lcIo );
				$( '#content, #jingle' ).addClass( 'show' );
				setTimeout( function() {
					$( '#jingle' ).css( 'display', 'none' );
				}, 3000 );
			}
		};
		function callbackMsg( _msg ) {
			...
			if ( _msg.msg == 'show' ) {
				window.location = _uri + _page + '?_session=' + _ssid + '&uuid' + _msg.uuid;
			}
